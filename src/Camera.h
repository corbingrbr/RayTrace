...
public:
    ...
    Camera(Eigen::Vector3f _location, Eigen::Vector3f _up, Eigen::Vector3f _right, Eigen::Vector3f _lookAt, int AA_res, bool jitter, bool gi, bool cartoon);
    virtual ~Camera();
...
private:
    ...
    Shade calcLocal(std::shared_ptr<Scene> scene, std::shared_ptr<Object> object, const Eigen::Vector3f& hitPoint, int gillumiter);
    ...
    Eigen::Vector3f cookTorrance(std::shared_ptr<Object> object, const Eigen::Vector3f& hitPoint, const Eigen::Vector3f& ray, std::shared_ptr<Light> light);
